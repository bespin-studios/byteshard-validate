...
class MinLength extends VariableValidation
{
    public function __construct(int $length)
    {
        parent::__construct($length);
        $this->setValidationUserData('bs_minlength', $length);
    }
    ...
    {
        return sprintf(Locale::get('byteShard.validate.rule.min_length'), $parameter);
    }
